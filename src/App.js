      ...
      <div className="App">
       <Nav count={this.state.cartCount} /> {/* Navbar  */}
        <header className="bg-dark py-5">
          <div className="container px-4 px-lg-5 my-5">
            <div className="text-center text-white">
              <h1 className="display-4 fw-bolder">Shop iphone</h1>
              <p className="lead fw-normal text-white-50 mb-0">New iphone 14 pro and beyond</p>
            </div>
          </div>
        </header>
        ...
        <footer className="py-5 bg-dark">
          <div className="container"><p className="m-0 text-center text-white">Copyright © Raghavendran 2023</p></div>
        </footer>
      </div>
    );
  }
